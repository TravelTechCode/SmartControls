		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#prismartcontrols-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"prismartcontrols-display": {
								"semanticObject": "prismartcontrols",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=pri.smartcontrols",
									"url": sap.ui.require.toUrl("pri/smartcontrols")
								}
							}
						}
					}
